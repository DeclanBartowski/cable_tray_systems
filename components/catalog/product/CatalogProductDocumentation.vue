...
<template>
  <div class="bg-gray mt-[60px] mb-[108px] py-[50px] laptop:mt-12 laptop:mb-20 laptop:py-10 tablet:mt-9 tablet:mb-14 tablet:py-8 mobile:mt-5 mobile:mb-6 mobile:py-6">
    <div class="container">
      <div class="product">
        <TabView
