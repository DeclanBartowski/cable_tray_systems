...
<template>
  ...
  >
    <div class="relative px-6 py-6">
      <nav class="pb-6 border-b border-b-solid border-b-gray">
        ...
        <div class="flex flex-col gap-6">
          <div class="flex flex-col gap-1">
            <a
              ...
              class="text-tabletM font-semibold"
            >8 800 308-72-42</a>
            <span class="text-tabletXs">Доставка для регионов круглосуточно</span>
          </div>
          <div class="flex flex-col gap-1">
            <a
              ...
              class="text-tabletM font-semibold"
            >+7 495 808-73-38</a>
            <span class="text-tabletXs">Москва, Пн-Пт с 8.00 до 17.00</span>
          </div>
          <div class="flex flex-col gap-1">
            <a
