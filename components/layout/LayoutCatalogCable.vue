  ...
  <div class="cable">
    ...
    >
      <TabPanel v-for="tabItem in sections"
        :pt="{ headerAction: { class: 'bg-white font-sans font-normal p-0 rounded-none border-l border-solid border-l-transparent border-b-none block w-[340px] border-b-none laptop:w-[300px] tablet:px-4 tablet:w-[290px] mobile:w-[240px] mobile:px-3' }}"
      >
        <template #header>
          <div class="py-4 pl-5 pr-6 flex items-center justify-between" v-if="tabItem.sub.length">
         ...
         <nuxt-link :to="tabItem.link" v-else>
